...
Use [`integrations/agentkit/README.md`](./agentkit/README.md) for a live relayer example that wires `createSNAPPlugin(...)` into an agent runtime with the devnet pool and relayer URL.
